...
class Program
{
    static void Main(string[] args)
    {
        ...
        // Core Requirement: Collecting numbers until the user enters 0
        ...
        // Core Requirement: Sum of numbers
        int sum = 0;
        ...
        // Core Requirement: Average of numbers
        double average = numbers.Count > 0 ? (double)sum / numbers.Count : 0;
        Console.WriteLine($"The average is: {average}");

        // Core Requirement: Maximum number
